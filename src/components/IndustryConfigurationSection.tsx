...
const PRESET_COLORS: Record<string, { bg: string; text: string; border: string; badge: string }> = {
  construction: { bg: "bg-amber-50", text: "text-amber-600", border: "border-amber-200", badge: "bg-amber-500 text-white" },
  healthcare: { bg: "bg-rose-50", text: "text-rose-600", border: "border-rose-200", badge: "bg-rose-500 text-white" },
  mining: { bg: "bg-orange-50", text: "text-orange-600", border: "border-orange-200", badge: "bg-orange-500 text-white" },
  manufacturing: { bg: "bg-blue-50", text: "text-blue-600", border: "border-blue-200", badge: "bg-blue-500 text-white" },
  logistics: { bg: "bg-emerald-50", text: "text-emerald-600", border: "border-emerald-200", badge: "bg-emerald-500 text-white" },
  corporate: { bg: "bg-indigo-50", text: "text-indigo-600", border: "border-indigo-200", badge: "bg-indigo-500 text-white" },
  aviation: { bg: "bg-sky-50", text: "text-sky-600", border: "border-sky-200", badge: "bg-sky-500 text-white" },
  oil_gas: { bg: "bg-red-50", text: "text-red-600", border: "border-red-200", badge: "bg-red-500 text-white" },
  custom: { bg: "bg-purple-50", text: "text-purple-600", border: "border-purple-200", badge: "bg-purple-500 text-white" }
};
...
export default function IndustryConfigurationSection() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 self-end md:self-center">
            <button
              ...
              disabled={isSaving}
              className="flex items-center gap-2 bg-[#007BC4] hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl text-xs font-bold shadow-sm hover:shadow transition disabled:opacity-50 cursor-pointer"
            >
      ...
      {/* Toast Feedback */}
      {saveToast && (
        <div className="p-4 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-xl text-xs font-bold flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-2">
              ...
              return (
                <div
                  ...
                  className={`relative rounded-2xl p-5 border transition-all flex flex-col justify-between ${
                    isActive
                      ? "bg-white border-[#007BC4] ring-2 ring-[#007BC4]/30 shadow-md"
                  ...
                  <div>
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-100 space-y-1 text-[11px]">
                      ...
                      <div className="flex items-center justify-between text-slate-600">
                        ...
                        <span className="font-semibold text-slate-800 truncate max-w-[130px]" title={preset.complianceFramework}>
      ...
      {activeTab === 'terminology' && (
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6">
            <h4 className="text-xs font-bold uppercase tracking-wider text-[#007BC4] border-b border-slate-100 pb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs font-semibold text-slate-900 focus:ring-2 focus:ring-[#007BC4] focus:bg-white outline-none"
            ...
            <h4 className="text-xs font-bold uppercase tracking-wider text-[#007BC4] border-b border-slate-100 pb-2 pt-2">
            ...
            <div className="flex justify-end pt-4 border-t border-slate-100">
              <button
                ...
                onClick={handleSaveAllToMongo}
                disabled={isSaving}
                className="flex items-center gap-2 bg-[#007BC4] hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl text-xs font-bold shadow-sm transition disabled:opacity-50 cursor-pointer"
              >
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs font-semibold text-slate-900 focus:ring-2 focus:ring-[#007BC4] focus:bg-white outline-none"
              />
              <button
                type="button"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2.5 pt-2">
              {rolesList.map((role, idx) => (
                <div
                  key={idx}
                  className="flex items-center justify-between px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-800 group hover:border-[#007BC4]/50 transition"
                >
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1.5 flex items-center justify-between">
                ...
                <span className="text-[10px] text-[#007BC4] font-mono font-semibold">Gemini 2.5 Flash Engine</span>
              </label>
              <textarea
                rows={4}
                value={formData.aiPersonaPrompt || ""}
                onChange={(e) => setFormData({ ...formData, aiPersonaPrompt: e.target.value })}
                className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3.5 text-xs font-mono text-slate-900 focus:ring-2 focus:ring-[#007BC4] focus:bg-white outline-none"
